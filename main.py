def creatEnemy():
    ...
    enemySprite = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    animation.run_image_animation(enemySprite,
        assets.animation("""
            myAnim0
        """),
        200,
        True)
    tiles.place_on_random_tile(enemySprite, sprites.dungeon.button_orange_depressed)
    enemySprite.follow(mySprite)
def titleScreen():
    music.play_melody("G B A G C5 B A B ", 120)
    game.splash("welcome to our awesome game")
